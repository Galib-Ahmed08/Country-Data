(function() {
  ...
  resultsContainer.addEventListener('click', async e => {
    ...
    fld.languages.textContent = c.languages ? Object.values(c.languages).join(', ') : 'N/A';
    fld.currencies.textContent = c.currencies ? Object.values(c.currencies).map(x => `${x.name} (${x.symbol})`).join(', ') : 'N/A';
